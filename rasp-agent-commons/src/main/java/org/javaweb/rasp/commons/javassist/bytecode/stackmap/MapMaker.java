...
package org.javaweb.rasp.commons.javassist.bytecode.stackmap;
...
import org.javaweb.rasp.commons.javassist.bytecode.ByteArray;
...
public class MapMaker extends Tracer {
    ...
    public static void main1(String className) throws Exception {
        ...
        //org.javaweb.rasp.commons.javassist.CtClass cc = cp.get(className);
        org.javaweb.rasp.commons.javassist.CtClass cc = cp.makeClass(new java.io.FileInputStream(className));
    ...
    public static void main2(String[] args) throws Exception {
        ClassPool cp = ClassPool.getDefault();
        //org.javaweb.rasp.commons.javassist.CtClass cc = cp.get(args[1]);
        org.javaweb.rasp.commons.javassist.CtClass cc = cp.makeClass(new java.io.FileInputStream(args[1]));
        MethodInfo minfo;
