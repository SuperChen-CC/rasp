...
import org.javaweb.rasp.commons.logback.core.rolling.helper.*;
...
public class FixedWindowRollingPolicy extends RollingPolicyBase {
    ...
    static final String PRUDENT_MODE_UNSUPPORTED = "See also "+ CoreConstants.CODES_URL+"#tbr_fnp_prudent_unsupported";
    static final String SEE_PARENT_FN_NOT_SET = "Please refer to "+ CoreConstants.CODES_URL+"#fwrp_parentFileName_not_set";
    int        maxIndex;
    int        minIndex;
