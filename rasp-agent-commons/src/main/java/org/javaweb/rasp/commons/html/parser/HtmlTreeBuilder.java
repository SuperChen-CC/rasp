...
import org.javaweb.rasp.commons.html.nodes.CDataNode;
...
import org.javaweb.rasp.commons.html.nodes.FormElement;
...
public class HtmlTreeBuilder extends TreeBuilder {
    ...
    protected void initialiseParse(Reader input, String baseUri, Parser parser) {
        ...
        tmplInsertMode = new ArrayList<HtmlTreeBuilderState>();
    ...
    List<Node> parseFragment(String inputFragment, Element context, String baseUri, Parser parser) {
        ...
        if (context != null) {
            ...
            if ("title".equals(contextTag) || "textarea".equals(contextTag)) {
                tokeniser.transition(TokeniserState.Rcdata);
            } else if ("iframe".equals(contextTag) || "noembed".equals(contextTag) || "noframes".equals(contextTag) || "style".equals(contextTag) || "xml".equals(contextTag)) {
                tokeniser.transition(TokeniserState.Rawtext);
            } else if ("script".equals(contextTag)) {
                tokeniser.transition(TokeniserState.ScriptData);
            } else if ("noscript".equals(contextTag)) {
                tokeniser.transition(TokeniserState.Data); // if scripting enabled, rawtext
            } else if ("plaintext".equals(contextTag)) {
                tokeniser.transition(TokeniserState.PLAINTEXT);
            } else if ("template".equals(contextTag)) {
