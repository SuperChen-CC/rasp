...
import static org.javaweb.rasp.commons.javassist.util.ReflectionUtils.invokeMethod;
import static org.javaweb.rasp.commons.javassist.util.ReflectionUtils.invokeStaticMethod;
...
class SecurityActions extends SecurityManager
{
    ...
    static Object getMethodHandle(final Class<?> clazz, final
                    ...
                    public Object run() throws IllegalAccessException,
	                    ...
	                    try {
		                    ...
		                    Object meth = invokeMethod(
				                    lookup, "unreflect", new Class[]{Method.class}, rmet
		                    );
