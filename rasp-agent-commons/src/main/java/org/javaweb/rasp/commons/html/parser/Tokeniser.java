...
import org.javaweb.rasp.commons.html.nodes.Entities;
...
public final class Tokeniser {
    ...
    private Token emitPending = null; // the token we are about to emit on next read
    ...
    private String lastStartCloseSeq; // "</" + lastStartTag, so we can quickly check for that in RCData
