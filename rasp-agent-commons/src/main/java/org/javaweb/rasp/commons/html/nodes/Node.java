...
import org.javaweb.rasp.commons.html.SerializationException;
...
public abstract class Node implements Cloneable {
    ...
    public List<Node> childNodes() {
        ...
        List<Node> rewrap = new ArrayList<Node>(children.size()); // wrapped so that looping and moving will not throw a CME as the source changes
     ...
     */
    public Node forEachNode(final Consumer<? super Node> action) {
