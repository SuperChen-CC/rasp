...
import org.javaweb.rasp.commons.logback.core.spi.LogbackLock;
...
import org.javaweb.rasp.commons.logback.core.util.ExecutorServiceUtil;
...
public class ContextBase implements Context, LifeCycle {
    ...
    protected void initCollisionMaps() {
        ...
        putObject(CoreConstants.RFA_FILENAME_PATTERN_COLLISION_MAP, new HashMap<String, FileNamePattern>());
    }
    ...
    private String lazyGetHostname() {
        String hostname = (String) this.propertyMap.get(CoreConstants.HOSTNAME_KEY);
        if (hostname == null) {
    ...
    private void putHostnameProperty(String hostname) {
        String existingHostname = (String) this.propertyMap.get(CoreConstants.HOSTNAME_KEY);
