 ...
 * @param <E>
 */
public class RASPOutputStreamAppender<E> extends UnsynchronizedAppenderBase<E> {
	 ...
	 */
	private ResilientFileOutputStream outputStream;
	 ...
	 * @return
	 */
	public ResilientFileOutputStream getOutputStream() {
		return outputStream;
	}
	 ...
	 */
	public void setOutputStream(ResilientFileOutputStream outputStream) {
		lock.lock();
		try {
