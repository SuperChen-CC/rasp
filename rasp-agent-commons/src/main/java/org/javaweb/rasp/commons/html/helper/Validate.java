...
public final class Validate {
     ...
     * @throws ValidationException if the object is null
     */
    public static void notNullParam(final Object obj, final String param) {
        if (obj == null)
     ...
     * @throws ValidationException if the object is null
     */
    public static Object ensureNotNull(Object obj, String msg, Object... args) {
        if (obj == null)
     ...
     * @throws ValidationException if the string is null or empty
     */
    public static void notEmptyParam(final String string, final String param) {
        if (string == null || string.length() == 0)
