...
import org.javaweb.rasp.commons.logback.core.rolling.helper.SizeAndTimeBasedArchiveRemover;
...
public class SizeAndTimeBasedFNATP<E> extends TimeBasedFileNamingAndTriggeringPolicyBase<E> {
    ...
    public void start() {
        ...
        if(usage == Usage.DIRECT) {
          ...
          addWarn("For more information see "+ CoreConstants.MANUAL_URL_PREFIX+"appenders.html#SizeAndTimeBasedRollingPolicy");
        }
