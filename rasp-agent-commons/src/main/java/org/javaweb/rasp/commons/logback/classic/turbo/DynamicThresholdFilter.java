...
import org.javaweb.rasp.commons.slf4j.MDC;
 ...
 *             class="org.javaweb.rasp.commons.logback.core.ConsoleAppender"&gt;
 *     &lt;layout class="org.javaweb.rasp.commons.logback.classic.PatternLayout"&gt;
 *       &lt;Pattern>TEST %d{HH:mm:ss.SSS} [%thread] %-5level %logger{36} - %msg%n&lt;/Pattern>
 *     &lt;/layout&gt;
 *   &lt;/appender&gt;
 *   
 *   &lt;turboFilter class=&quot;turbo.org.javaweb.rasp.commons.logback.classic.DynamicThresholdFilter&quot;&gt;
 *     &lt;Key&gt;userId&lt;/Key&gt;
