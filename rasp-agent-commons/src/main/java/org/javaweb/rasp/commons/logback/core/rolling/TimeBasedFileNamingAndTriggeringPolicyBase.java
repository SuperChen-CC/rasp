...
import org.javaweb.rasp.commons.logback.core.rolling.helper.DateTokenConverter;
import org.javaweb.rasp.commons.logback.core.rolling.helper.RollingCalendar;
...
abstract public class TimeBasedFileNamingAndTriggeringPolicyBase<E> extends ContextAwareBase implements TimeBasedFileNamingAndTriggeringPolicy<E> {
    ...
    static private String COLLIDING_DATE_FORMAT_URL = CoreConstants.CODES_URL + "#rfa_collision_in_dateFormat";
