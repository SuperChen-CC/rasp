...
import static org.javaweb.rasp.commons.javassist.util.ReflectionUtils.invokeMethodProxy;
...
public class DefinePackageHelper
{
    ...
    private static class Java7 extends Helper {
        ...
        private final Object definePackage = getDefinePackageMethodHandle();

        private Object getDefinePackageMethodHandle() {
            ...
            throws IllegalArgumentException
        {
            if (stack.getCallerClass() != DefinePackageHelper.class)
                throw new IllegalAccessError("Access denied for caller.");
            try {
				return invokeMethodProxy(
						definePackage,"invokeWithArguments", new Class[]{Object[].class},
						loader, name, specTitle, specVersion, specVendor, implTitle, implVersion, implVendor, sealBase
				);
            } catch (Throwable e) {
