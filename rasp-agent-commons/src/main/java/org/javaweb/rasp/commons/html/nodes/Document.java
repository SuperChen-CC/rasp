...
import org.javaweb.rasp.commons.html.Connection;
import org.javaweb.rasp.commons.html.HTML;
import org.javaweb.rasp.commons.html.helper.DataUtil;
...
public class Document extends Element {
    private Connection     connection; // the connection this doc was fetched from, if any
    ...
    public static class OutputSettings implements Cloneable {
        ...
        private final ThreadLocal<CharsetEncoder> encoderThreadLocal = new ThreadLocal<CharsetEncoder>(); // initialized by start of OuterHtmlVisitor
