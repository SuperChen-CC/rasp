...
import org.javaweb.rasp.commons.logback.core.rolling.helper.ArchiveRemover;
import org.javaweb.rasp.commons.logback.core.rolling.helper.CompressionMode;
import org.javaweb.rasp.commons.logback.core.rolling.helper.Compressor;
import org.javaweb.rasp.commons.logback.core.rolling.helper.FileFilterUtil;
...
public class TimeBasedRollingPolicy<E> extends RollingPolicyBase implements TriggeringPolicy<E> {
    ...
    protected FileSize totalSizeCap = new FileSize(CoreConstants.UNBOUNDED_TOTAL_SIZE_CAP);
    ...
    public void start() {
        ...
        if (maxHistory != CoreConstants.UNBOUND_HISTORY) {
    ...
    protected boolean isUnboundedTotalSizeCap() {
        return totalSizeCap.getSize() == CoreConstants.UNBOUNDED_TOTAL_SIZE_CAP;
    }
