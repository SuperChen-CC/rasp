...
package org.javaweb.rasp.commons.javassist.util.proxy;
...
import org.javaweb.rasp.commons.javassist.bytecode.DuplicateMemberException;
...
public class ProxyFactory {
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "proxy.util.org.javaweb.javassist.RuntimeSupport";
     ...
     * @since 3.24
     */
    public Class<?> createClass(Object lookup) {
        if (signature == null) {
            computeSignature(methodFilter);
        }
     ...
     * @since 3.24
     */
    public Class<?> createClass(Object lookup, MethodFilter filter) {
        computeSignature(filter);
        return createClass1(lookup);
    }
     ...
     */
    Class<?> createClass(Object lookup, byte[] signature)
    {
        installSignature(signature);
        return createClass1(lookup);
    }

    private Class<?> createClass1(Object lookup) {
    ...
    private void createClass2(ClassLoader cl, Object lookup) {
    ...
    private void createClass3(ClassLoader cl, Object lookup) {
    ...
    private static MethodInfo makeWriteReplace(ConstPool cp) {
        ...
        code.addAload(0);
        code.addInvokestatic("proxy.util.org.javaweb.javassist.RuntimeSupport",
                             "makeSerializedProxy",
