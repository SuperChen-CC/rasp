...
import org.javaweb.rasp.commons.javassist.util.ReflectionUtils;
 ...
 * <code>org.javaweb.rasp.commons.javassist.Loader</code>
...
public class Loader extends ClassLoader {
    ...
    private void init(ClassPool cp) {
        ...
        translator = null;
        domain = null;
        delegateLoadingOf("org.javaweb.rasp.commons.javassist.Loader");
    }
    ...
    private boolean isDefinedPackage(String name) {
        if (ClassFile.MAJOR_VERSION >= ClassFile.JAVA_9) {
            try {
                return ReflectionUtils.invokeStaticMethod(ClassLoader.class, "getDefinedPackage", new Class[]{String.class}, name) == null;
            } catch (Exception e) {
