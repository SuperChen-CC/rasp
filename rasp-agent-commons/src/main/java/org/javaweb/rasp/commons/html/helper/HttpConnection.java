...
import org.javaweb.rasp.commons.html.UncheckedIOException;
import org.javaweb.rasp.commons.html.*;
import org.javaweb.rasp.commons.html.internal.ConstrainableInputStream;
...
import org.javaweb.rasp.commons.html.parser.TokenQueue;
...
import static org.javaweb.rasp.commons.html.internal.Normalizer.lowerCase;

/**
 * Implementation of {@link Connection}.
 * @see HTML#connect(String)
 */
...
public class HttpConnection implements Connection {
    ...
    private static abstract class Base<T extends Connection.Base<T>> implements Connection.Base<T> {
        ...
        private Base(Base<T> copy) {
            ...
            cookies = new LinkedHashMap<String, String>(); cookies.putAll(copy.cookies); // just holds strings
        }
    ...
    public static class Request extends HttpConnection.Base<Connection.Request> implements Connection.Request {
        ...
        Request(Request copy) {
            ...
            data = new ArrayList<Connection.KeyVal>(); data.addAll(copy.data()); // this is shallow, but holds immutable string keyval, and possibly an InputStream which can only be read once anyway, so using as a prototype would be unsupported
            body = copy.body;
    ...
    public static class Response extends HttpConnection.Base<Connection.Response> implements Connection.Response {
        ...
        private Response(HttpURLConnection conn, HttpConnection.Request request, HttpConnection.Response previousResponse) throws IOException {
            this.conn = conn;
            this.req = request;
